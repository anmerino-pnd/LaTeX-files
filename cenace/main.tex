...
\begin{frame}{\textquestiondown Cómo funciona por dentro?}
\begin{center}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[
    font=\sffamily\small,
...
\node[clave, right=1.8cm of frag] (num1) {Se vuelven\\vectores\\{\scriptsize\itshape\textcolor{gray}{bge-m3}}};
...
\node[clave, right=1.8cm of preg] (num2) {Se vuelve\\vector\\{\scriptsize\itshape\textcolor{gray}{bge-m3}}};
\node[draw=structure.fg, cylinder, shape border rotate=90, aspect=0.3,
      fill=structure.fg!10, very thick, minimum height=1.4cm, minimum width=2.2cm,
      align=center, right=1.8cm of num2] (db2) {Base de\\datos};
\node[clave, right=1.8cm of db2] (rel) {Fragmentos\\relevantes};
\node[caja, below=1.4cm of rel] (mll) {Modelo de\\lenguaje\\{\scriptsize\itshape\textcolor{gray}{gemma3:4b}}};
...
\draw[flecha] (preg.south) |- ([yshift=-1cm]preg.south) -| (mll.north)
